export function PeopleCard(item) {
  ...
  const actor_age = document.createElement("p");
  ...
  actor_age.classList.add("actor_age");
  ...
  actor_age.innerHTML = item.id;

  actor_card.append(rank, actor_info);
  actor_info.append(actor_name, actor_english_name, actor_age);
